...
<body>
  ...
  <div id="wrapper">
    ...
    <input type="hidden" name="return" value="http://localhost/lagranjita/receptor.php">
    <input type="hidden" name="cancel_return" value="http://localhost/lagranjita/pago_cancelado.php">
